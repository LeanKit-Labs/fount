...
describe('Resolving', function () {
  ...
  describe('when resolving functions', function () {
    ...
    describe('with static lifecycle', function () {
      before(function () {
        ...
        fount.register('b', 2)
        fount.register('c', new Promise(resolve => resolve(3)))
  ...
  describe('when registering and resolving 10k of keys', function () {
    it('should register 10k keys in the same container in 50 ms', function () {
